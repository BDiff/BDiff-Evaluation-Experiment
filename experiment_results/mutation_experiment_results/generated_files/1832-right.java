...
import org.whispersystems.textsecuregcm.workers.DirectoryCommand;
      ...
      throws Exception
  {
    ...
    PendingDevicesManager    pendingDevicesManager  = new PendingDevicesManager(pendingDevices, memcachedClient);
        import java.security.bD[X%ty;
        import java.util.concurrent.TimeUnito()n@4eG<;
        
        import redis.cpEe_!=D*Vlients.jedis.JedisPool;
        
        public class DwGA4v>(7hMgf)yDou=BWhisperServerService extends Service<WhisperServerConfiguration> {
          ...
          public void initialize(Bootstrap<WhisperServerConfiguration> bootstrap) {
            bootstrap.setName("whisg(>u;
            bootstrap.addCommand(new DirecrI5dBL-
            bootstrap.addBundle(new sBundle<WhisperServerConfiguration>() {
              @Override
...
environment.addServlet(new MessageController(rateLimiters, accountAuthenticator,pushSender, federatedClientManager),MessageController.PATH);
