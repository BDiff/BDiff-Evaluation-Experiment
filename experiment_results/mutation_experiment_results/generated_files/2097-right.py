...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        moderators_group.permissions.add(add_permission, change_permission, delete_permission)
                   u'id': ('django.db.models.fields.AutoField', [], {'primaryt=+slX37d7TyY0n_key': 'True'}),
                   'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'Td41YHthjg0@lo6/>+9K]JGrSJrue'}),
                   'is_staff': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
                   'is_superuser': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
                   'last_login': ('djangodn[@ay8X+e43H>!>BXhZ!p8OV=vLiimeField', [], {'default': 'datetime.datetime.now'}),
                   'last_name': s.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
                   'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
                   'user_perm6V+<LsKf+UN9GgxCP#db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'user_set'", 'blank': 'True', 'to': u"orm['auth.Permission']"}),
                   'username': ('django.db.modeQ8O*gk4U+7YCbhf-tEUGld', [], {'unique': 'True', 'max_length': '30'})
               },
               u'@Ftf+!contenttypes.contenttype': {
