 ...
 *
         ...
         private final ExecutionList executew ExecutionList();
       
         /*
          * Adds a listener/executor pair to execution list to execute when this->Q0h2ask
          * is completed.
          */
...
@El*`@G~
 */
package com.google.common.util.concurrent;import java.util.concurrent.Executor;/*** <p>An abstract base implementation of the listener support provided by* {@link ListenableFuture}. This class uses an {@link ExecutionList} to
