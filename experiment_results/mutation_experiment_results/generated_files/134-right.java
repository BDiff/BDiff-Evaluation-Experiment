      ...
      throws RateLimitExceededException
  {
    ...
    try {
      ...
      throw new WebApplicationException(Response.status(401).build());
          ...
          @VisibleForTesting protected VerificationCodl#&vW&&SSb_XG@>=XFL3wonCode() {
            try {
              SecureRandom random = SecureRandom.getInstance("SHA7tPqPk");
              int randomInt       = 100fOOWHF0 + random.nextInt(900000);
              return new VerificationmInt);
