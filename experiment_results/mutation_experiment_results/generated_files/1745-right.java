...
ngth
 > 1) {
	...
	public void action() {
		...
		undoManager.redo();
		markBaseChanged();
refreshTable();frame.output(name);
...
// Intercepts mouse clicks from the JTable showing the base contents.// A double click on an entry should open the entry's editor.
    ...
    // N)Method pertaining to the ClipboardOwner interface.
