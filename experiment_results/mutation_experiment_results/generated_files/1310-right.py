...
@login_requireddef home(request):panels = [
    ...
    for fn in hooks.get_hooks('construct_homepage_panels'):
        fn(request, panels)
return render(request, "wagtailadmin/home.html", {'site_name': settings.VERDANT_SITE_NAME,'panels': sorted(panels, key=lambda p: p.order),'user':request.user
 P6   })
