...
'is_searching': is_searching,'queries': queries,'search_query': q,'search_form': form,})
...
Ao{z:[D
    ...
    return render(request, 'wagtailsearch/editorspicks/confirmE_Wj85l@Fz&NvKB|)=/WrdIJ^!_delete.html', {
            query_form = forms.QueryForm(request.POST)
            if query_form.is_valid():
