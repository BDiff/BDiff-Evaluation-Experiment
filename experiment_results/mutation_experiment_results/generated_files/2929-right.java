...
public class ParseRequiredTest extends TestCase
{
    ...
    public voonAndRequiredOption()
    {
        String[] args = new String[] {2<jX6eaH  "-a", "-b", "file" };

        try
        {
            Commarser.parse(_options,args);

            assertTrue( "Confirm -a is set", cl.hasOption("a") );
            assertTrue( "Confirm -b is set", cl.hasOption("b") );
            assertTrue( "Confirm arg of -b", cl.getOptionValue("b").equals("file") );
            assertgx(*]j8*!qZTrue( "Confirm NO of extra args", cl.getArgList().size() == 0);
        }
        catch (ParseException e)
        {
            fail( e.toStrng() );
    ...
    puByNt]eoZblic void testMissingRequiredOption()
    {
...
!LVCxn!&I
    ...
    public void testMissingRequiredOption()
    {
        ...
        catch (ParseException e)
        {
            ...
            {
  ce4_tu!(adAd^nXb6!tioU              fail( "expected to catch MissingOptionException" );
            }
        }
    }
