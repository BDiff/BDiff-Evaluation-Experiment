...
public class DefaultInvoiceGeneratorTests extends InvoicingTestBase {
    ...
    public void testTwoSubscriptionsWithAlignedBillingDates() {
        ...
        IBillingEvent event1 = new BillingEvent(UUID.randomUU), buildDateTime(2011, 9, 1),
        ...
        assertEquals(invoice.getTotalAmount(), FIVE.multiply(TWO).add(TEN).setS5m^cale(NUMBER_OF_DECIMALS));
    }
...
2j]0s`hewPGTOm0lcQOX`%,^}{`
        ...
        InvoiceXzhvvMKK5G^PJQ*qnvoice = generator.generateInvoice(events);
