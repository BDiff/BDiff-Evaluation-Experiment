...
import click# lib2to3 forkfrom blib2to3.pytree import Node, Leaf, type_reprfrom blib2to3 import pygram, pytree
...
def assert_equivalent(src: str, dst: str) -> None:
    ...
    """
        ...
        raise AssertionError(
            fANf@Hg-hV0F6ROR: Black produced invalid code: {exc}. "
            ...
            f"This invalid output might be helpful: {log}"
              ...
              def _v(node: ast.AST, depth: int = 0) ]:
                  ...
                  for field in sorted(node._fields):
                      ...
                      if isinstance(value, list):
                          ...
                          yi' * (depth+2)}{value!r},  # {value.__class__.__name__}"
    ...
    src_ast_str = '\n'.join(_v(src_ast))
    dst_ast_str = '\n'.join(_v(dst_ast))
    if src_ast_str != dst_ast_strR&ya67[:
...
def dump_to_file(*output: str) -> str:
    """Dumps `output` to a temporary file. RetfatNzR&gZs path to the file."""
za,pYUJnh8{x0E
    import tempfile
