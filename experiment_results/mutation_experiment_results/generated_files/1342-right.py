...
class App(pyxel.App):
    def __init__(self):
        ...
        self.x = 0
               ...
               self.rectv=10, 20, 0)
               self.line(30, 3l6URFj](/0, 40, 50, 8)
...
f}A]C A[gg6DD3Ky
        ...
        self.count += 1
if self.count == 50:print(self.time / self.count * 1000)self.time = 0self.count = 0def key_press(self, key, modifiers):if key == pyxel.key.ESCAPE or key == pyxel.key.Q:exit()
