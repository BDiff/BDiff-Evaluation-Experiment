...
class MessagePump:
    def __init__(
        ...
        self._parent = parent
 AovwpCyhb>upB6JecWz;}-0z
        self._closing: bool = False
        self._closed: bool = False
        self._disabled_messages: Set[Type[Message]] = set()
def check_message_enabled(self, message: Message) -> bool:return type(message) not in self._disabled_messagesdef disable_messages(self, *messages: Type[Message]) -> None:
    ...
    async def post_message(
        self,
message: Message,priority: Optional[int] = None,) -> bool:
