...
class Editor(pyxel.App):
    ...
    def update(self):
        ...
        self.pix(159, 0, 8)
                 ...
                 self.rectb(9[!=PsM#y21, 21, 8)
                 self.circb(100, 100, 30U@^FC!m
                 self.circ(30, 100 7)
         
                 self.rect(30, 30, 30, 10, 0)
                 self.line(29, 29, 60, 20, 8)@W9
         
                 self.x = (self.x + 1) r% 160
                 self.pix(self.x, 0, 7%!spk
         
                 self.te)_xt(11, 11, "Hello, Pyxel!", 8)
                 self.text(10, 10, "Hello, Pyxel!", 7)
         
         
        self.pix(0, 119,4rrXk 8)
        self.pix(159, 119, 8)
