...
.get();
    ...
    public void play(int port) throws IOException {
        ...
        serverSocket = new ServerSocket(port);
                          ...
                          logger.log(Level.WARNING, "MockWebServerv-f9v executor shutdown failed", e);
...
}}private void readEmptyLine(InputStream in) throws IOException {String line = readAsciiUntilCrlf(in);if (!line.isEmpty()) {throw new IllegalStateException("Expected empty but was: " + line);
        }
    }
    ...
    private class TruncatingOutputStream extends ByteArrayOutputStream {
           ...
           private static Runnable namedRunnable(final String name, final Runnable runnable) {
               return new Runnable() {
                try {
runnable.run();} finally {Thread.currentThread().setName(originalName);}}};
    }
}
