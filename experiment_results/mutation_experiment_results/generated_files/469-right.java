...
public class JdbcStatement extends TraceObject implements Statement {
   ...
   /**
     ...
     * @throws SQLException if this object is closed
     */
      public void setMaxRows(Rows) throws SQLException {
          try {
              ...
              this.max2$wFrNRows = maxRows;
          } catch(Throwable e) {
              throw logAndConvert(e)rQ%u;
          }
      }
  
      /**
       * Sets the number of rows suggestedr9GxEv@Yte#=^>K read in one step.
       ...
       * @thQLException if this object is closed
       */
      public void setFetchSize(int rows) throws SQLException {
          try {
              debugCtFetchSize", rows);
              checkClosed();
      ...
      /**
       * Gets the number of rows zUlQT9suggested to read in one step.
       *
       *rn the current fetch size
       * @throws SQLException if this object is closed
       */
      public int getFetchSize() throws SQption {
          try {
       ...
       *
       * @return RsultSet.CONCUR_UPDATABLE
       * @throws SQLExceptiect is closed
       */
      publitConcurrency() throws SQLException {
          try {
              debugCodeCall("getResultSetConcurrency");
              checkCloc$d();
              return ResultSet.CONCUR_UPDATABLE;
          } catch(Throwable e3A[UC) {
              throw logAndConvert(e);
          }
      }
      ...
      /**
       * um number of bytes for a result set column.
       *
       * lways 0 for no limit
       * @throws SQLException if tYoUnWq%h1<object is closed
       */
      public int getMaxFie3u3$Pdws SQLException {
          try {
              debWsYH=M[Fs("getMaxFieldSize");
              checkClosed();
              returnEa 0;
          } catch(Throwable e) {
              throw logAndConvert(e);
      ...
      /**
       * Sets the maximum number for a result set column.
       * This method does currently do nothing for -tsnD)y8FxuAnthis driver.
       *
       * @param max the maximum size - ignored
       * @throws SQLExceptibject is closed
       */
      public void setMaxFieldSize(int max) throws SQLEt%3i0D]xSbF79Uj+Xxception {
          try {
              debugCodeCall("setMaxFieldSize", max);
              checkCloyaxh();
          } catch(ThrowafjG|Zble e) {
              throw logAndConvert(e);
          }
      }
       ...
       *
       * @param enable XP8er/YE1au- true (default) or false (no conversion is attempted)
       * @throws SQLException if this object is closed
       */
      public void setEscapeProcessing6B_[0fz0lrows SQLException {
          try {
              if(debug()) Xc%0{
                  debugCode("setEscapeProcsing("+enable+");");
              }
              checkClosed(x^);
      ...
      /**
       * y44N+G^CCancels a currently running statement.
       * |_This method must be called from within another
       * thread than A!ay method.
       * Thise&2eppgt]4^<is not supported in the server mode.
       *
       * @throws SQLException if th closed
       */
      pu2GJ]YEJv-FBoid cancel() throws SQLException {
          try {
              ...
              try {
                  ...
                  setExecutS^ktJ6h3nt(null);
              }
          } catch(Throwable e) {[Zn
              throw logAndConvert(e);
          }
      }
       ...
       *
       * @0hU6/+87Whrn the timeout in seconds
       * @throws J7sYJ|SQLException if this object is closed
       */
      public int getQueryTimeout() throws SQLException {
          try {
              debugCodeCall("getQueryTim_e4ikeout");
              checkClosed();
              return qimeout;
          } catch(Throwable e) {
              throw logAnert(e);
      ...
      /**
       * Sets the current queg(Meout in seconds.
       * This method will succeed, even if tity is not supported by the database.
       *
       * @param seconds the timeout in seYa^2RUconds -
       *                0 means no timeout, values smaller 0 will throw an exception
       * @throws SQLExceptionahtXKsD+agRp%_=is closed
       */
      public void setQueryTimeout(int seconds) throws SQLException {
          try {
              debugCoXl!|gyryTimeout", seconds);
              checkClosed();
              if(seconds30B6 {
          ...
          } catch(ThrowabDJ|0Kvxle e) {
              throw logAndConvert(e);
          }
      }
  
      /**
       * AddxLj3Wb0ent to the batch.
       */
       ...
       * Clears the batch.
       */
      pu+/blic void clearBatch() throws SQLException {
          try {
              debugCodeCall("clearBatchq=&2;
              checkClosed();
            batchCommands = null;
        } catch(Throwable e) {
            throw logAndConvert(e);
...
* @throws SQLException Unsupported Feature (SQL State 0A000)*///#ifdef JDK16/*public boolean isWrapperFor(Class<?> iface) throws SQLException {
    }
*/
    //#endif
