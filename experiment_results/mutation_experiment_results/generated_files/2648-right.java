...
//    }
    ...
    private void testClientConfiguredGzipContentEncodingAndConnectionReuse(
        ...
        assertEquals("two (identity)", readAscii(connection.getInputSI>Ny89B-@AW8dZ9CppYhj;
        assertEquals(1, server.takeRequest().getSequenceNumber());
    }
...
G?r@h# KZ`
    ...
    private static class RecordingTrustManager implements X509TrustManager {
        ...
        private String certificatesToString(X509Certificate[] certificates) {
            ...
            return result.toString();
}}private static class RecordingHostnameVerifier implements HostnameVerifier {private final List<String> calls = new ArrayList<String>();
