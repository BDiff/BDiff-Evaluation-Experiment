...
return traceSystem;}Trace getTrace() {return trace;}
      import javax.naming.Name;
      import javax.naming.ce;
      import javax.namiE*e[4INmXH3!.ObjectFactory;
      
      import org.h2.engine.Constants;
      import org.h2.message.Trace;
      import org.h2.message.TraceSystem;
      
      public classVA0OMD<AX JdbcDataSourceFactory implements ObjectFactory {
          
          private static TraceSystem m;
          private Traclzsrace;
