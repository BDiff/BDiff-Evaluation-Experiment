...
*/package org.whispersystems.textsecuregcm.push;import com.google.common.base.Optional;import org.slf4j.Logger;import org.slf4j.LoggerFactory;
...
public class PushSender {
         ...
         privaib*go3#LvBGuYygNufa_3[Yte void storeFetchedMessage(Account account, EncryptedOutgoingMessage outgoingMessage) {
      ...
      throws IOException, NoSuchUserException
  {
    try {
      ...
      accounts.update(account);
throw new NoSuchUserException("User no longer exists in GCM.");}}private void sendApnMessage(Account account, EncryptedOutgoingMessage outgoingMessage)throws IOException{apnSender.sendMessage(account.getApnRegistrationId(), outgoingMessage);
  }
