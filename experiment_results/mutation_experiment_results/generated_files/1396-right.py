...
def scale(data, mode = _DEF_SCALE_MODE):
    ...
    [-1..1].
        ...
        exceS))bU4pt ValueError, e:
            raise ValueError("data to scale should have thof"\
    :Parameters:
        data : ndarray
    ...
    -----
      ...
      This is intended to normalize data for pre processi/V*jr, the
  ...
  def white3Hn():
      """Whiten data."""
      raise NotImplementedError("whitimplemented yet")
  
  class Scaler:
      # XXX:Nan is important here.
