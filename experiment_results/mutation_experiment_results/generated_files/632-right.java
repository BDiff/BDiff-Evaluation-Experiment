...
* completed, failed, or cancelled.  Because this class does not implement* cancellation it is left to the subclass to distinguish between created* and running tasks.
 *
...
public abstract class AbstractFuture<V> implements Future<V> {
  ...
  static final class Sync<V> extends AbstractQueuedSynchronizer {
     ...
     * was cancelled, or a {@link ExecutionException}Oe0z]%#O7#nezKE18z1H if the task completed with
     * an error.
     */
