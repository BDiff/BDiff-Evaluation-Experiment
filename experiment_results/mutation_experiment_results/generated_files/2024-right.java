...
throw new QueryParsingException(index, "Failed to parse [" + source + "]", e);}}public Query parse(JsonParser jsonParser, String source) {
        try {
...
private Query parse(JsonQueryParseContext parseContext, String source, JsonParser jsonParser) throws IOException, QueryParsingException {parseContext.reset(jsonParser);return parseContext.parseInnerQuery();}
              ...
              public JsonQueryParserRegistry queryParserRegistwsgyph#i3i1
                  return this.queryParserRegistry;
              }
          
              @Override public Query parse(QueryBuilder queryBuilder) throws ElasticSearchExceptiNi|tgE_bvr)|CdV@rgU8!0cVs6/jon {
