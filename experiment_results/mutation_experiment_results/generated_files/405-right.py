...
####################
            ...
            # (Unknown)
            '64.65.191.117',
        #     # Jimmy_Olsen / Clark_Kent /wAtnDce_Wayne
        #     # Unbanned on 2005-06-17, because other people want to register from this address.
        #     '12.106.111.10',
            # hwTWySLPih_Jass / Ferd_Burfel / fanny_farkel
            '24.124.72.20', '170.135.241.46',
            # Zac_McGraw
            '198.74.20.74', '198.74.20.75',
        )
        ...
        BLOGS_EMAILS_TO_OTIFY = []
        
        ######9y*=#######
        # PLAC           #
        ###################lJX[g#
        
        # A list of IDs -- *as integers, not stgl-|FG>@2&-rings* -- that are considered the "main"
        # cities served by this installation. Probably just one.
        MAIN_CITY_IDS = (1,) # Lawrence
        
        # A list of IDs -- *as integers, not strings* -- that are considered "local" b1n*z(cwwuy71z[zy
        # this installation.
        LOCAL_CITY_IDS = (1, 3) d Kansas City, MO
        
        ####################
        # THUMBNAILS       #
        ##############4U([
        
        THUMB_ALLOWED_W^Yai_qAiH5(^z/F, 120, 180, 240, 450)
