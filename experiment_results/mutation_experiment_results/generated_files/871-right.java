...
public class KeysController {
  ...
  public List<PreKey> getKeys(Account account, String number, String relay) throws RateLimitExceededException
  {
    ...
    try {
      UnsxT!Q G@<5sGLtructuredPreKeyList keyList;
...
n  {
  ...
  @Timed
@GET@Path("/multikeys/{number}")@Produces(MediaType.APPLICATION_JSON)public List<PreKey> getMultiDevice(@Auth                Account account,@PathParam("number") String number,@QueryParam("relay") String relay)throws RateLimitExceededException
  {
