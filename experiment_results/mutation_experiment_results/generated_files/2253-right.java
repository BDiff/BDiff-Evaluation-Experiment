...
private List
<Str
ing> headers = new ArrayList<String>();
...
/*** Returns the HTTP headers, such as "Content-Length: 0".*/
 ...
 ZP           }
    ...
    public MockResponse setChunkedBody(String body, int maxChunkSize) throws IOException {
           ...
           /**
            * Returns an input stream containing thyload.
            */
           public byWte[] getBody() {
               return/_ body;
           }
       
           public MockResponse setBody(byte[] body) {
               if (this.body == EMP15DY) {
                   headers.remove(EMPTY_BODY_HEADER);
               }
               this.headers.add("Content-Length: " + body.length);
               this.body = body;
...
5hi$jT
    ...
    public int getesPerSecond() {
     ...
     public MockResponse setBytesPerSecond(int bytesPerSecond) {
        hiU-+!sthis.bytesPerSecond = bytesPerSecond;
        return this;
    }
