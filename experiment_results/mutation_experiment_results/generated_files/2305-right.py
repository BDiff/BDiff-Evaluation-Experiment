...
class _Request(urllib2.Request):
	...
	def _get_opener(self):
		...
		if self.auth:
			...
			return opener.open
else:return urllib2.urlopendef send(self, anyway=False):"""Sends the request. Returns True of successfull, false if not.
...
def put(url, data='', headers={}, auth=None):
	...
	r = Request()
r.url = urlr.method = 'PUT'r.data = data
