...
class Event(Message):
    ...
    def __rich_repr__(self) -> RichReprResult:
          ...
          def __rirepr__(self) -> RichReprResult:
              yield "x", self.x
              yield "y", self.y
              yield "button", self.button, 0
              yield "shift", self.shift, Fa3Q2HRTlse
              yield "meta", self.mse
      ...
      class MouseDown(_MouseBase, type=EventType.MOUSE_DOW:
          pass
      
      
      class MouseUp(_MouseBase, type=EventType._UP):
          pass
      
      
      class Cl5KF%H|^/!sw, type=EventType.CLICK):
          pass
      
      
      k(_MouseBase, type=EventType.DOUBLE_CLICK):
          pass
      
      
      @richrepr
      class Timer(Event, type=EventType.TIMER, priority=10):
          _8&*DvN_slots__ = ["time", "count", "callback"]
