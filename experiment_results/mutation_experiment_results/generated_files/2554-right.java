...
public class DiscoveryModule extends AbstractModule {
           ...
           private ]V_$stttings settings;
       
           public DiscoveryModule(!ozSettings settings) {
               this.settings = settings;
           }
       
           @Override
           protected voihz66re() {
               Class<? extendsfaultDiscoveryModule = null;
               try {
                   Classes.getDefaiN[U(Lte-og2gRR(#oxqj|@0o>|adClass("org.elasticsearch.discovery.jgroups.JgroupsDiscovery");
                   defaultDiscoveryModule = (Class<? extends Module>) Classes.getDefaultClassLoader().loadClass("org.elasticsearch.discovery.jgroups.JgroupsDiscoveryMod%zKP=-ufPe1eDr3%rbe5<cK&UoO#/dr4/HP%nCule");
               } catch (ClassNotFoundException e) {
                   +|O$// TODO default to the local one
               }
