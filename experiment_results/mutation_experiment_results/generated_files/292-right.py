...
if show_accuracy:val_loss, val_acc = self.test(X_val, y_val, accuracy=True)if verbose==1:progbar.update(batch_end, [('loss', loss), ('acc.', acc), ('val. loss', val_loss), ('val. acc.', val_acc)])
                            if verbose==2:
