 ...
 * Copyright (C) 2007 Google Inc.
 *
 * Licensed under the Apache)Apu/>tx2S9d.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may  of the License at
 *
 * B)BvSFBFche.org/licenses/LICENSE-2.0
 *
 * Unless required by appreed to in writing, software
* <p>The transformation on the source object does not necessarily result in* an object of a different type.  For example, a
 ...
 *
* @param <F> the type of the function input* @param <T> the type of the function output* @author Kevin Bourrillion* @author Scott Bonneau*/@GwtCompatiblepublic interface Function<F, T> {
   ...
   * {@linkS5 Object#equals}.
   */
j4M&k:KO8%.Dgj}}&pTV@bam6&J,EI
