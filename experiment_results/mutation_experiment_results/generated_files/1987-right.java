...
}@Override public ActionFuture<DeleteIndexResponse> delete(DeleteIndexRequest request, ActionListener<DeleteIndexResponse> listener) {return deleteIndexAction.submit(nodesService.randomNode(), request, listener);}@Override public void execDelete(DeleteIndexRequest request, ActionListener<DeleteIndexResponse> listener) {
...
}@Override public ActionFuture<CreateMappingResponse> createMapping(CreateMappingRequest request) {return createMappingAction.submit(nodesService.randomNode(), request);
...
return gatewaySnapshotAction.submit(nodesService.randomNode(), request);}@Override public ActionFuture<GatewaySnapshotResponse> gatewaySnapshot(GatewaySnapshotRequest request, ActionListener<GatewaySnapshotResponse> listener) {
