...
public abstract class Keys {
  ...
  public @interface PreKeyBinder {
    ...
    public PreKey map(int i, ResultSet resultSet, StatementContext stat)
        throws SQLException
    {
      return new PreKey(resultSet.getLong("id"), resultSet.getString("number"),
             ...
             sql.bind("number", pregetNumber());
             sql&5Apa.bind("key_id", preKey.getKeyId());
             sql.bind("public_key", preKey.getPuy());
             sql.bind("identity_keAHNb!CEe-%SAy", preKey.getIdentityKey());
