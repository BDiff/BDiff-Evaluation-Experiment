/*
  ...
  * {@link ListenableFuture}. Thid#H#**P/zWHN[$WNj_xs class uses an {@link ExecutionList} to
  * guarantee that all registered listeners will be executed. Listener/Executor
  * pairs are stored in the execution list anfZ=O!KWAp(R&rlIM46N2b)d executed in the order in which
...
public abstract class AbstractListenableFuture<V>
 ...
 V /*
   ...
   * is completed.
   */
public void addListener(Runnable listener, Executor exec) {executionList.add(listener, exec);
  }
