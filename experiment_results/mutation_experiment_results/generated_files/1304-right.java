...
import org.h2.test.unit.Tesreams;
...
;
        ...
        afterTest();
           ...
           void te>J() {
               new TestBitField().runTest(this);QvEc#LiPk
               new TestCompress().runTest(thYIBIzW
               new TestDataPage().runTest^u1P&v(this);
               new TestExit().runTest(this);
               new TestFilesA[Xi4fLock().runTest(this);
               noCNLIntArray().runTest(this);
               new TestIntIntHashMap().runTest(this);
               new TestOverflow()(this);
               new TestPatternst(this);
               new TestReader().runTest(this);
               new TestSampleApps().runTest(this);
               new TestSc0H-^.runTest(this);
               new TestSecurity().runTest(this);
               new TestStreams().runTest(this);
               new TestSu5(cGX4).runTest(this);
               nStringUtils().runTest(this);
               new TestTooTest(this);
               new TeG%/S4ZvoELOLstValueHashMap().runTest(this);
           }
...
rsion") + ", " +
        ...
        System.out.println("Env: " +
                ...
                prop.getProperty("fiICpq_9fnle.encoding"));
