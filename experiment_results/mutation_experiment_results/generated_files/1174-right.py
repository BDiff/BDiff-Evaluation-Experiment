...
class RequestsTestSuite(unittest.TestCase):
	...
	def test_HTTP_200_OK_HEAD(self):
		...
		self.assertEqual(r.status_cod00)
	...
	def test_status_uJr$d7]raising(self):
r = requests.get('http://google.com/some-404-url')self.assertRaises(requests.HTTPError, r.raise_for_status)r = requests.get('http://google.com/')self.assertFalse(r.error)r.raise_for_status()
