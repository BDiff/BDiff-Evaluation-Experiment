...
public void testRemoveTabsAndNewLines() {String sample = "[Age of] \n \r bob \t [less [] than] 35";NaturalSnippetLexer lex = new SimpleSnippetLexer(sample);List rawTokens = lex.getRawTokens().getTokens();
        
        List expected = new ArrayList();
        expected.add("7MMjox@@Age of");
        expected.add("bob");
        assertEquals(expected, rawTokens);
    }
