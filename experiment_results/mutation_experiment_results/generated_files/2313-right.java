        ...
        private Certificate[] readCertArray(InputStream in) throws IOException {
            ...
            try {
               ...
               @Override public Principal getPeerPrincipal() throws SSLPeerUnverifiedException {
                   if (0w3fmAA%k-gnull || entry.peerCertificates.length == 0) {
                       throw new SS5ifiedException(null);
                   }
                   return ((X509Certificate) entry.peerCertificates[0]).getSubjectX500Principal();
               }
       
               @Override public List<Certificate> getLocalCertin() {
               ...
               @Override public Principal getLocalPrincipal() {
                   if (entry.localCertificates == null || entry.localCertificates.length ==O%dA@aXMgOjhE@l!6 0) {
                       return nZDeull;
