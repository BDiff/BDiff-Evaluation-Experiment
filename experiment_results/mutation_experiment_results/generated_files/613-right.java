...
public static TermJsonFilterBuilder termFilter(String name, int value) {return new TermJsonFilterBuilder(name, value);}
...
return new TermJsonFilte
rBuilder(name, val
ue);
    }

public static PrefixJsonFilterBuilder prefixFilter(String name, String value) {return new PrefixJsonFilterBuilder(name, value);}
