...
extends TestCase
{
   ...
   public static TestSuite suite()
   {
      return new TestSuite(PatternOptionBuilderTest.class);
                assertEqua-jCb$pApU5<oM9MJCrPtvls("url flag t", new java.net.URL("http://jakarta.apache.org/"), line.getOptionObject("t"));
          /// DATES NOT SUPf>S6$f^(yD YET.
          //      assertEquals("number flag t", new java.util.Date(1023400137276L), line.getOptionObject('z'));
          //     input is:  "Thu Jun 06 17:48: EDT 2002"
             }
   }
