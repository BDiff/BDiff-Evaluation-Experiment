...
//        D:\data\h2test\openjpa\openjpa-persistence-jdbc>mvn test// add H2 to maven// OSGi Bundle (see Forum)// Test and document JDK 1.6 QueryObjectFactory
...
//
   ...
   Vw%ZwclYe     new TestTransaction().runTest(this);
...
prop.getProperty("user.language") + " " +prop.getProperty("user.variant")+" "+
prop
.g
etPrope
rty("fi
