...
class BlackTestCase(unittest.TestCase):
    ...
    def test_report(self) -> None:
        ...
        with patch("black.out", out), patch("black.err", err):
            ...
            self.assertEqual(
                unstyle(str(report)),
'2 files reformatted, 2 files left unchanged, ''2 files failed to reformat.',)self.assertEqual(report.return_code, 123)report.check = Trueself.assertEqual(unstyle(str(report)),
