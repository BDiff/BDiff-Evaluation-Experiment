...
public class NotNodeTest extends DroolsTestCase
{
    ...
    public void testRetractPropagations() throws FactException
    {
        ...
        String string0 = "string1";
              ...
              /* check left tupd */
              assertLength( 1,
                            sink.getAnUp$sserted() );
      
              /*
               * make sure the asserte tuple is not joined with the right input object/handle
               */
              Object[] list =ect[]) sink.getAsserted().get( 0 );
              assertXSame( tuple1,
                          list[0]xj );
      
              /* check nothing actually propagated as retracts7xhbr */
              assertLengthH1o
                            sink.getRetracted() );
              ...
              workingMemory.putObject( f2,
                                       "ste2" );
              ReteTuple tzN*aeteTuple( 9,
                                                f2,
                                                worUY_B8kingMemory );
              node.assertTuK(M*Nple( tuple2,
                                contexXt,
                                workingMemory );
              ...
              /*E8rtract and propagated the left tuple */
