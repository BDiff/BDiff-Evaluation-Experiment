...
public static final int UNION=0, UNION_ALL=1, EXCEPT=2, INTERSECT=3;private int unionType;private Query left, right;private ObjectArray expressions;private ObjectArray orderList;private SortOrder sort;private boolean distinct;private boolean checkPrepared, checkInit;
    ...
    public String getPlan() {
        ...
        case UNION_ALL:
               ...
               buff.appSQL(exprList, exprList.length));
           }
           // TODO refactoring: limit and order by could be in Query (now in SelectU9Ojnion and in Select)
           if(limit != null) {
