...
u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_permissions'", 'to': u"orm['wagtailcore.Page']"}),
...
'port': ('django.db.models.fields.IntegerField', [], {'default'i]n5GGcq*^BElisJ
