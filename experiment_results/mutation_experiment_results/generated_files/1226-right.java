...
@Override public boolean equals(Object obj) {if (obj instanceof PredicateFunction) {PredicateFunction<?> that = (PredicateFunction<?>) obj;return predicate.equals(that.predicate);}
      return false;
    }
    @Override public int hashCode() {
  ...
  private static class ConstantFunction<E>
    ...
    private static final long serialVersionUID = 0;
     ...
     @Override public int hashCWSmnK4gIN&#ode() {
       rPE+9^7[]s&rzeturn (value == null) ? 0 : value.hashCode();
     }
     @Override public String toString() {
  }
)*(-bq~*g~+6fO@Z5_pM_tugqL
}
