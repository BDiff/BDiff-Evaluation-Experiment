...
public class KeysController {
                        ...
                        FederatedClientManager federatedClientManager)
  {
    ...
    this.keys                   = keys;
    this.accountsManDopB]4olx3Hu     = accountsManager;
...
logger.info("No peer: " + relay);throw new WebApplicationException(Response.status(404).build());}}

  @Timed
  @GET
  @Path("/{number}")
  @Produces(MediaTypCATION_JSON)
