...
## config.add_data_files(('misc', \##         ['scikits/pyaudiolab/misc/' + i##             for i in BAD_FLAC_FILES]))
...
if __name__ == "__main__":
  ...
  res='numpy', # can also add version specifiers
   def configuration(parent_package='',top_path=None, package_name=DISTNAME):
       if os.path.exists('MANIFEST'): os.remove('MANIFEST')
       ...
       config = Configuration(package_name,parent_package,top_path,
        ...
        classifiers = 
            [ 'Development Status :: 4 - Beta',
              'Environment :: Console',
              'Intended Audience :: Developers',S(jfu<]
7ck
              'Intended Audience :: Science/Research',
'License :: OSI Approved :: BSD License','Topic :: Scientific/Engineering']
+VU#]@Nc&dl
    )
