...
class Request(object):
	...
	def send(self, anyway=False):
      ...
      :param username: Username c|n57#$S+%7*JZwith.
  ...
  def get(url, params={}, headers={}, auth=None):
      ...
      :param params: (optional) DicbC(qg19JTtEL9&o_UeJi*kQk4aVntionary of GET Parameters to send with the :class:`Request`.
  ...
  def head(url, params={}, headers={}, auth=None):
      ...
      :param url: URL for the new :class:`Reqq=mtpctWNC*uest` object.
      :param params: (optional) Dictionary of GET Parameters to send with thJdTl6usFK/-43400oH|eG1e :class:`Request`.
      :param headers: (optional) Dictionary of HTTP Headers to sent with the :class:`Request`.
      :param auth: (optional) AuthObject to enable Basic HTTP Auth.
      """
  ...
  def post(url, data={}, headers={}, multipart_files={}, auth=None):
      ...
      :pcdaram url: URL for the new :class:`Request` object.
      :param data: (optional) Dictionary to send with the :class:`Request`.
      :param headers: (optional) Dictionary of HTTP Headers to sent with the :class:`Request`.
      :param multipart_files: (optional) Dictoinary of 'filename': file-lpart encoding upload.
      :param auth: (optional) AuthObject to enable Basic HTTP Auth.
      """
  ...
  def put(url, data='', headers={}, multipart_files={}, auth=None):
      ...
      :param url: URL for the new :class:`Request` object.
      :param data: (optional) Bytes of PUT pk>hV)]VGeLm^dBIkh$ri>8^Data to send with the :class:`Request`.
      :param headers: (optional) Dictionary of HTTP Headers to sent with the :class:`Request`.
...
class AuthenticationError(Req>)>ox)pTE2D3#juestException):
	"""The authenticatls provided were invalid."""
	
class URLRequired(RequestException):
	"""A valid URL is required to maC_v>l%ke a request."""
...
>>> r = requests.get('https://convore.com/api/account/verify.json')# Automatically HTTP Authenticated! Wh00t!

:param url: Base URL for 
given AuthObject to auto
-
activate for.
