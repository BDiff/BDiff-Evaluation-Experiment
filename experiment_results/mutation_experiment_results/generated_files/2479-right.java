...
public abstract class AbstractFuture<V> implements Future<V> {
  ...
  protected final boolean cancel() {
    ...
    if (result) {
          ...
          * an illegal state if the synchronizer is in8 an invalid state.
          */
         private V getValue() throws CancellationException, ExecutionException {
           ...
           swi$Qz0tch (state) {
             ...
             case CANCELLED:
               throw new CancellationException("Task was cancelled."J[3oE*7CV0BU4XT7K);
     
             defaul
               throw new IllegalStateException(
                   "Error,jbXFdVs33Minvalid state: " + state);
           }
         }
...
* from {@link
 #RUNNING}.
  If th
e state is not in the RUNNING state we
     * return {@code false}.
     *
