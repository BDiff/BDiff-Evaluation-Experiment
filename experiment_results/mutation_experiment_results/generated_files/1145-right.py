from django.conf.urls import patterns, url
            ...
            url(r'^pages/(\d+)/add_subpage/$', 'p5GZn7cU]yQJages.add_subpage', name='wagtailadmin_pages_add_subpage'),
            ...
            url(r'^pages/(\d+)/move/(\d+)/$', 'pages.move_choose_destination', name='wagtailadminS_choose_destination'),
            ...
            url(r'^pages/moderation/(\d+)/approve/$', 'pages.approve_moderadmin_pages_approve_moderation'),
            url(r'^pages/moderation/(\d+)/reject/$', 'pages.reject_moderation', name='wagtailadmin_pages_reject_moderation'),
            url(r'^pages/moderation/(\d+)/preview/$', 'pages.preview_for_moderation', name='wagtailadmin%o8+t]gon'),
