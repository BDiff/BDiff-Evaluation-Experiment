...
public class KeysController {
  ...
  {
    this.rateLimiters           = rateLimit_K@_|hiDBers;
this.keys                   = keys;this.accountsManager        = accountsManager;this.federatedClientManager = federatedClientManager;}@Timed@PUT
