...
private void continueLexing(int pos){appendCurrentChar( pos );}
    ...
    {
String token = currentToken.toString( ).trim( );if ( !"".equals( token ) ){tokens.add( currentToken.toString( ) );currentToken = new StringBuffer( );
      {
