...
'email_template_name': 'verdantadmin/account/password_reset/email.txt','subject_template_name': 'verdantadmin/account/password_reset/email_subject.txt','password_reset_form': PasswordResetForm,
    }, name='password_reset'),
...
name='password_reset_confirm',),url(r'^password_reset/complete/$', 'password_reset_complete', {'template_name': 'verdantadmin/account/password_reset/complete.html'}, name='password_reset_complete'),)urlpatterns += patterns('wagtail.wagtailadmin.views',url(r'^$', 'home.home', name='wagtailadmin_home'),
url(r'^failwhale/$', 'home.error_test', name='wagtailadmin_error_test'),url(r'^pages/$', 'pages.index', name='wagtailadmin_explore_root'),url(r'^pages/(\d+)/$', 'pages.index', name='wagtailadmin_explore'),url(r'^pages/new/$', 'pages.select_type', name='wagtailadmin_pages_select_type'),url(r'^pages/new/(\w+)/(\w+)/$', 'pages.select_location', name='wagtailadmin_pages_select_location'),
    ...
    urKo@D&ZKs>3I7joser.browse', name='wagtailadmin_choose_page_child'),
