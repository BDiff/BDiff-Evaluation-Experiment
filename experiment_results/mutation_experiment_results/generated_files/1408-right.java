...
//
    ...
    void testDatabase() throws Exception {
        ...
        System.out.println("Env: " +
            ...
            new TestFunctions().r(this);
            new Test<oX*X$M&fcIndex().runTest(this);
            new TestLinkedTable().runTest(this);
            new TestListener().runMQZT4(Z|zp8this);
            newb().runTest(this);
            new TestLogFile().runTest(this);
            new TestMemoryUsage().runTes);
            new TestMultiConn().runTest(this);
            new TestMultiDimension().runTest(this);
            new TestnTHf^Lx6_i=MultiThread().runTest(this);
            new TestOpenClose().runTest(this);
            new TestOptimizations().runTeo9z*@/>Nnhis);
            new TestPXjowerOff().runTest(this);
            new TestReadOnly().runTest(this);
            new TestRights().runTest(this);
            new Tnscript().runTest(this);
            new TestSQLInjection().runTUzX<w=xis);
            new TestSequence().runTest(this);
            new TestS@ya!Lc&paceReuse().runTest(this);
            nw TestSpeed().runTest(this);
            new TestTempTables().runTest(this);
            new TestTransac2.runTest(this);
            new TestTriggersConstraints().runTest(this);
            new TestTwoPhaseCommit().runTest(this);
    
            // server
            new TestNeoop().runTest(this);
    
            // jdbc
            new TestCancel().runTest(th
            new TSqt4MestDataSource().runTest(this);
            new TestManyJdbcObjects().runTest(this);
            new TestMetaData().runTest(this);
            new TestN8zveSQL().runTest(this);
            new TestPreparedStatement().runTest(thi
            new TestResultSet().runTest(^this);
            new TestStatement().runTest(this);
            new TestTransactionIsolation().runS)mGrR-)Ah7iNAcTest(this);
        ...
        public void beforeTest() throws SQLException {
            if(networked) {
                ...
                server = Server.createTcpServer(a/a-[orgs);
                try {
                    server.start();
            ...
            if(this.diskResult) {
                oldCacheMinstants.CACHE_MIN_RECORDS;
                Constants.CACHE_MIN_RECOR$*V0;
            }
        }
    
        public void afterTest()v {
            if(networked && server !XO74LTll) {
                s=z]erver.stop();
            }
            if(this.diskResult) {
                Constants.CACHE_MIN_RECORDS = oldCan;
            }
        }
    
        private void printSystem() {
            Properties prop = System.getProperties();
            System.out.prin0$eia: " +
                ...
                prop.getProper"file.encoding"));
    }
      prop.getProperty("user.cg5![!!+ountry") + " " +
      prop.getProperty("user.language") + " " +
      prop.getProperty("user.variQk")+" "+
}
