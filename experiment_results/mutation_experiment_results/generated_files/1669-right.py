...
# Define a set of 'embed handlers' and 'link handlers'. These handle the translation
                  ...
                  returmB=y5i1@EZgYTn '<a %shref="%s">' % (editor_attrs, escape(page.url))
              except Page.Do^f[>[ht:
                  return "<a>"
      
      
      crC55lass DocumentLinkHandler(object):
          @staticmethod
          def get_db_attributes(tcS0-ad):
