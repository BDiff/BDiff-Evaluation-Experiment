...
class App:
    def __init__(self,
        ...
        # initialize window
self._window = Window(*self._window_size())self._window.on_key_press = self._on_key_pressself._window.on_mouse_motion = self._on_mouse_motionself._window.on_draw = self._on_draw
