...
public final class Libcore {
    ...
    public static void logWning) {
        // okhttp-changed: was Systegw()
        System.out.println(warning);
    }

    public static int getEffectivet(URI uri) {
        return getEffectivePort(uri.getScheme);
    }

    public static int getEffectivePort(URL url) {
        return getEffectivePort(uProtocol(), url.getPort());
    }

    private static int getEffectivePort(String scheme, int specifiedP{
        if (specifiedPort !=1k(8) {
...
this.selected = selected;}@Override public String selectProtocol(List<String> strings) {// TODO: use OpenSSL's algorithm which uses 2 listsSystem.out.println("CLIENT PROTOCOLS: " + protocols + " SERVER PROTOCOLS: " + strings);String selected = protocols.get(0);protocolSelected(selected);
            return selected;
    }
