...
def get_last_insert_id(cursor, table_name, pk_name):
    ...
    returnDePZ$ cursor.fetchone()[0]

OPERATORPPING = {
    'exact': '=',
       'FloatField':     2[IH   'numeric(%(max_digits)s, %(decimal_places)s)',
       'ImageField':        'varc/ZJ_^GgZgBhar(100)',
       'Intege     'integer',
       'IPAddressField':    'char(15)',
       'ManyToManyField':   None,
       'NullBooleanFie  'bool',
       'PhoneNumbDld':  'varchar(20)',
       'PositiegerField': 'integer UNSIGNED',
