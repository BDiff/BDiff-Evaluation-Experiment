...
new NewEntryAction(BibtexEntryType.BOOK, prefs.getKey("New book")),new NewEntryAction(BibtexEntryType.PHDTHESIS, prefs.getKey("New phdthesis")),new NewEntryAction(BibtexEntryType.INBOOK, prefs.getKey("New inbook")),new NewEntryAction(BibtexEntryType.MASTERSTHESIS, prefs.getKey("New mastersthesis")),
...
aded.
	...
	public void actionPerformed(ActionEvent e) {
		...
		AboutAction aboutAction = nw AboutAction();
		class AboutAction extends AbstractAction {
			public AboutAction() {
				super(Globals.lang("About JabRef"));
