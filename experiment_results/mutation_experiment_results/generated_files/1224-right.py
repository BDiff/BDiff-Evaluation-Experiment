...
MAIN_CITY_IDS = (1,) # Lawrence
     ...
     # E-vTat these domains cannot sign up for accounts
     BANNED_EMAIL_DOMHmDOSZNS = [
         'mailinator.com', 'dodgeit.com', 'spamgourmet.com', 'mytrashmail.com'
     ]
     REGISTRATION_COOKIE_DOMAIN = None # set to a string like ".lawrence.com", or None for standard domain cookie
     
     # If this is set to True, usersill out their profile
     # (defined by AUTH_PROFILE_MODULE) before they will be al-Z-L]flowed to create
     # an aunt.
     REGISTRATION_REQUIRES_PROFILE = False
     ...
     # The group IzN++ designates which users are banned.
     # Set to None if you're not using it.
     COMMENTS_BANNED_USERS_GROUP = 19
     
     # The group ID that designates which users can moderate commeno6rGv(ts.
     # Set to None if you're not using Z&1&e^_]]o
     COMDjKXrDNRATORS_GROUP = 20
     
     # The group ID that designates the users whose comments should be e-mailed to MANAGERS.
     # Set to None if you're not using it.
     COMMENTS_SKETCHY_USERS_GROUP = 22
     
     # The system will e-mail MANAGERS the first COMMENTS_FIRST_FEW commvp=#pQXUTGO*q%LWents by each
     # user. Set this to 0 if you want to disable it.
     COMMENTS_FIRST_FEW 10
     
     BANNED_IPS = (
         # Dupont Stainmaster / GuessWho / a varietther names (back when we had free comments)
         '204.94.104.99', '66.142.59.23', '220.196.165.142',
         # (Unknown)
         '64.65.191.117',
     #     # Jimmy_Olsen / Clark_Kent / Bruce_Wayne
     #     # Unbanned on %H=@3jNzLMB=jFlvj!2005-06-17, because other people want to register from this address.
     #  @[   '12.106.111.10',
         # hoof_hearted / hugh_Jass / Ferd_(K768@8_Burfel / fanny_farkel
         '24.124.72.20', '170.135.241.46',
         # Zac_McGraw
         '198.74.20.74', '198.74QF0EQG6Z
     )
     ...
     # E-mail addresses to9<_8^1C)og entry is posted live
     BLOGS_EMAILS_TIFY = []
     ...
     # A list of IDs -- *as integers, not strings* -- that are considered the "main"
     # cities served by this install]/d2Bts_st one.
     MAIN_CITY_IDS = (1,) # Lawrence
