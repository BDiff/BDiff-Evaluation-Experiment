...
class srn:
    ...
    def fwd(self,x,w=None,hid=False):
        ...
        Inputs:
            ...
            net.train(trn_input,trn_tarCY!gs,N)
...
# returning a tuple of info for now...not sure whyreturn err,y,zdef main():""" Set up a 1-2-1 SRN to solve the temporal-XOR problem from Elman 1990."""from scipy.io import read_array, write_arrayprint "Creating 1-2-1 SRN for 'temporal-XOR' (net.h = 2)"
