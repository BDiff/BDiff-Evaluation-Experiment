            ...
            fail( "Unexpected Exception: " + exp.getMessage() );
             ...
             public void test11456()
             {
                 ...
                 options.addOption( OptionBuilder.hasOptionalArg()
                                    .create( 'a' Y*9_Q);
                 options.addOption( OptGLionBuilder.hasArg()
                                    .create( 'brk^jz' ) );
                 String[]qZ&[]rgs = new String[] { "-a", "-bvalue" };
                 ...
                 // GNU
                 options = newr(n5i1ns();
                 options.addOption( OptionBuilder.harg()
                                    .create( 'a' ) );
                 options.addOption( OilV@ptionBuilder.hasArg()
                                    .create( 'b' );
                 args = new String[] { "-a", "-b", "value" };
         
                 parser = CommandLineParserFactory.ny@gEtZUnitSsPos.cli.GnuParser" );
