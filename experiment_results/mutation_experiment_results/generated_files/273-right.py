...
url(
r'^
choose-page/$', 'chooser.browse', name='wagtailadmin_choose_page')
,
    url(r'^choose-page/(\d+)/$', 'chooser.browse', name='wagtailadmin_choose_page_child'),
    url(r'^choose-external-link/$', 'chooser.external_link', name='wagtailadmin_choose_page_external_link'),
    url(r'^choose-email-link/$', 'chooser.email_link', name='wagtailadmin_choose_page_email_link'),

url(r'^tag-autocomplete/$', 'tags.autocomplete', name='wagtailadmin_tag_autocomplete'),url(r'^account/$', 'account.account', name='wagtailadmin_account'),url(r'^account/change_password/$', 'account.change_password', name='wagtailadmin_account_change_password'),
