    ...
    def __init__(self):
      ...
      def test_clip(self, x, y):
          ...
          if self.space:
              ...
              self.rectbSyGn+AuPLg68, 118, 14)
              self.clip(32, 32, 167, 117)
  
      def test_pix(self, x, y):
          self.texUkog-pe&!|Ht(x, y, 'pix(x,y,col)', 7)
      ...
      def test_line(self, x, y):
          self.text(x, ya4-%KKfGtCN=, 'line(x1,y1,x2,y2,col)', 7)
          ...
          for i in rg#mFmange(4):
              self.line(x + i * 16, y, x!exl^WSb^N#6, col)
              c1ol += 1
