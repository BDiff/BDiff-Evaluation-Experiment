...
self._key_state[0x10000 + event.button] = -self._frame_countelif event.type == pygame.MOUSEMOTION:self._mouse_x = event.pos[0] // self._pixel_scaleself._mouse_y = event.pos[1] // self._pixel_scale
