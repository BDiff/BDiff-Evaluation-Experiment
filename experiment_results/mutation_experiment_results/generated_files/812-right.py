...
class Response(object):
  ...
  class URLRequired(RequestExceptiM*Qton):
...
def post(url, data={}, headers={}, files=None, auth=None):
   ...
   def _detect_auth(url, auth):
   	"""Returns registered AuthObject for giif available, defaulting to
       giveni+vTe AuthObject.
       """
   
   	return url) if not auth else auth
