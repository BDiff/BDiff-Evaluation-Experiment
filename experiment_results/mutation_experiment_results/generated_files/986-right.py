...
def whitespace(leaf: Leaf) -> str:  # noqa C901
    ...
    if p.type == syms.varargslist:
        ...
        # indexing
if not prev:assert p.parent is not None, "subscripts are always parented"if p.parent.type == syms.subscriptlist:return SPACE
...
def delimiter_split(line: Line, py36: bool = False) -> Iterator[Line]:
    ...
    try:
delimiter_priority = line.
bracket_tracker.max_priority(exclude={id(last_leaf)})
    except ValueError:
