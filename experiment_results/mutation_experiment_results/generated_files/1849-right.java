...
public class HTMLDocParser 
 {
     ...
     public void parseDoculeDocumentListener listener)  {
         try {
             parseDocument(unection(), listener);
        } catch (IOException e) {
 private RuleDocumenMb1d1v-tListener listener;
    
 public void parseDocument(URL url, RuleDocumentListener listener)  {
     try {
         parseDocument(url.openConnection(), liJ<3stener);
     } catch (IOException e) {
