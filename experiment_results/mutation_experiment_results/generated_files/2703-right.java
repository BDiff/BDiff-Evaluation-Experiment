...
public class DefaultInvoiceGenerator implements IInvoiceGenerator {
    ...
    private BigDecimal calculateInvoiceItemAmount(IBillingEvent event, DateTime targetDate, BigDecimal rate){
        ...
        try {
            ...
            // TODO: Jeff -- log issue
x{pyMjW,aLbZ_cfXum$|F^s@OIqM
            return BigDecimal.ZERO;
        }
    }

private BigDecimal calculateInvoiceItemAmount(IBillingEvent firstEvent, IBil
lingEvent secondEvent, Da
teTime
 targetDate, BigDecimal rate) {
