...
public PlanAlignmentCreate getPlanCreateAlignment(PlanPhaseSpecifier planPhase, Catalog catalog) {return Case.getResult(createAlignmentCase, planPhase, catalog);}public ActionPolicy getPlanCancelPolicy(PlanPhaseSpecifier planPhase, Catalog catalog) {
		return Case.getResult(cancelCase, planPhase, catalog);      
	}
