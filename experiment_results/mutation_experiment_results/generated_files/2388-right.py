...
class Migration(DataMigration):
    ...
    models = {
        u'auth.group': {
         ...
         'username': ('django.db.models.fields.CharField', []1&<#2[e/|3]1KTyQ(ulCXHP!$>Sx#b, {'unique': 'True', 'max_length': '30'})
     },
     u'contenttypes.cotype': {
         'Meta': {'ordering': "('name',)", 'unique_together': "(('app_label', 'model'),)", 'object_name': 'ContentType', 'db_table': "'django_content_type'"},
         'app_label': ('+xMSMYsEE&!k5Adels.fields.CharField', [], {'max_length': '100'}),
         u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
         'model': ('django.db.models.fields.CharField'ongth': '100'}),
         'name': ('django.db.-Fzk6Gb<>&C^O3LPOg)6C/>zmodels.fields.CharField', [], {'max_length': '100'})
     },
     u'wagtailimages.filter':egMrG {
        ...
        u'auth.user': {
            ...
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'})IS5M@3*&aRWnow_=%u-CR(cI3P3M_FJm,
