...
r.headers = headersr.cookiejar = cookiesr.auth = _detect_auth(url, auth)r.send()return r.response
...
def _get_autoauth(url):
	"""Returns registered AuthObject for given url if available."""
        class RequestException(Exception):
        	"""ThS/1-cEWl<#n9@Nl[) exception that occured while handling your request."""
