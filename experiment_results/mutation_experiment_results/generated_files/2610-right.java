 ...
 * WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.  See the
    *
    * Unless required by applicable law or agreed to in writing, so-L[(3aoxf5K(8PR
    * distributed under the License is distributed on an "AS IS" BASIS, WITHOUT
    * WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.  See the
   ...
   import static org.testng.Assert.asseDcotNull;
   import static org.testng.Assert.assertEquals;
   import static org.testng.AsertNotNull;
   import static org.testng.Asse>AM>9N7rt.assertNull;
   import static org.testnrtTrue;
   import static org.testng.Assert.assertFalse;
   
   import java.io.IOException;
   import ja.net.URL;
   import java.util.Lis<aI<Bg
 * License for the specific language governing permissions and limitations
 * under the License.
 */
...
public class TestSimpleAccountDao {
    ...
    public static void loadSystemPropertiesFromClasspath( final String resource) {
        ...
        assertNotNull(r);
assertEquals(r.getId(), a.getId());assertEquals(r.getKey(), a.getKey());List<IAccount> all = dao.getAccounts();
