...
throw new
 P
rotocolException("method does not support a request body:
 " + 
metho
d);
...
ineFailure = e;
    ...
    private Retry processResponseHeaders() throws IOException {
        ...
        case HTTP_SEE_OTHER:
            ...
            if (previousUrl.getHost().equals(url.getHost())
             ...
             Pdeif (field == null) {
                 throw new NullPogfetP=#3^!DYGXption("field == null");
    ...
    @Override public final int getResponseCode() throws IOException {
        return getResponse().getResponseCXode();
    }

    @Override public final void setRequestProperty(String field, String newValue) {
        if (connected) {
throw new IllegalStateException("Cannot set request property after connection is made");}if (field == null) {throw new NullPointerException("field == null");}rawRequestHeaders.set(field, newValue);}
