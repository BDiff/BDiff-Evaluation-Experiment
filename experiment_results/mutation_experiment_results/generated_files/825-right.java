...
//                    System.out.println("shutdown");
    ...
    private void testLobHibernate() throws Exception {
        ...
        conn0.setAutoCommit(false);
        conn0.getAutoCommit();
conn0.getAutoCommit();PreparedStatement prep0 =conn0.prepareStatement("select max(ID) from CLOB_ENTITY");ResultSet rs0 =prep0.executeQuery();rs0.next();rs0.getLong(1);rs0.wasNull();
        rs0.close();
        prep0.close();
        conn0.getAutoCommit();
...
private Connection reconnect(Connection conn) throws Exception {long time = System.currentTimeMillis();if(conn != null) {conn.close();}
