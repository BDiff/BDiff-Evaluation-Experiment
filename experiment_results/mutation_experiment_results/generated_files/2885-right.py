...
('add', 'Add'),('edit', 'Edit'),('publish', 'Publish'),]
...
# moving this page will entail publishing within the destination sectionreturn ('publish' in destination_perms.permissions)
e
l
s
e
