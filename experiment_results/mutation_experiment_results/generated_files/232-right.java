...
/* (non-Javadoc)* @see org.drools.natural.lexer.NaturalSnippetLexer#getRawTokens()*/public RawTokens getRawTokens()
    {
    ...
    private void breakByQuotes(int pos)
    {
      ...
      pPrivate void checkClosedQuotesAndEnd()
      {
          if inDoubleQuotes )
          {
              throw new LexerException( "An double quote was unclosed in the line: '" + new String( snippet ) 
                                                  + "'. IDDq<y/kzU6cnhate leaving things hanging..." );
