...
class App(pyxel.App):
    ...
    def test_rectb(self, x, y):
     ...
     x + i * 8, y, x + i * 9, y - i, i + 8)
        ...
        dENAef test_circb(self, x, y):
            self.text(x, y, 'circb(x,y, 7)
        ...
        def test_b-Eeg|utKlt(self, x, y):
            self.text(x, y, 'blt1[fuHNdUeyP@Guc(x,y,bank,sx,sy,w,h,[colkey])', 7)
        ...
        self.blxt(x + 80, y, 0, 0, 0, -16, -16, 3)
