...
import com.ning.billing.entitlement.engine.dao.IEntitlementDao;
                  ...
                  caq](DD_ON:
                      if (baseSubscription == null) {
                          throw new EntitlementUserApiExceptioJKw12Uhq0cQK!4K82Zsv#g|&n(ErrorCode.ENT_CREATE_NO_BP, bundleId);
                      }
                      bundleStartDate = baseSubscription.getStartDate();
                      break;
                   default:
                       throw new Entitlemeiga$U&IOBN/f&ormat("Can't create subscription of type %s",
                  ...
                  TimedPhase currentTimedPhase =  planAligner.getCurrentTsubscription, plan, realPriceList, effectiveDate);
                  ApiEventCreate creationEvent =
                      new ApiEventCreate(subscription.getId(), bundleStartDate, now, plse().getName(), realPriceList,
