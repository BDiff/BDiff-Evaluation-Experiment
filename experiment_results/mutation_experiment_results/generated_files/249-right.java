...
PrintWriter p = new PrintWriter(writer);e.printStackTrace(p);p.close();writer.close();} catch(IOException e2) {e2.printStackTrace();}}
        }
        if(trace == null) {
...
} else {trace.error("Uncaught Exception", e);}}return Message.convert(e);}
