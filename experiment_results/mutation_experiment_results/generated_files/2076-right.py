...
if __name__ == "__main__":
    ...
    from rich.console import Console
from . import eventsconsole = Console()from .app import App

    class MyApp(App):
async def on_startup(self, event: events.Startup) -> None:self.set_timer(5, callback=self.close_messages)
