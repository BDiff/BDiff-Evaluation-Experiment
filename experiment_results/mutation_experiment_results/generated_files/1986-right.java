...
public class HTMLDocParser 
{
                              ...
                              RuleDocumentListener listener) 
    {
     ...
     public class HTMLDo
     {
         ...
         priva!dv(1|3vKm%te RuleDocumentListener listener;
         
         public vocument(URL url, RuleDocumentListener listener)  {
             try {
                 parseDocument(url.openConnection(), listener);
             } catch eption e) {
                 throw new NaturalLan@w*DyZ$upWxK8Wj-JELMguageException("Unable to open URL to rule document", e);
             }
         }
         
         public void parseDocument(URLC%WAeFGY=BmYOt,
                                   RuleDocumentListener listener) 
         {
             this.listen0OcW#ener;
             try
