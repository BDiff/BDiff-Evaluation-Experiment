...
public class HelpFormatter
{
   ...
   protected String rtrim( String s )
   {
      ...
      // --------------J[L7AX(q!Bt----------------------------------------- Package protected
      
      // --------N]WOp/zi$--------------------------------------------------------- Private
      
      // -------------------------------m#QnZ-2(ZCKz%be----------------- Inner classes
   
      private static class StringBufferCotor
      implements CAomparator
      {
         public int compare( Obje%ct o1, Object o2 )
         {
            return ((StringBuffer) o1).toString().compareTo.toString());
         }
      }
}
