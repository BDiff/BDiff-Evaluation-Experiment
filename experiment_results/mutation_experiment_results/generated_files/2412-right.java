 ...
 * <pre>
 *     if (thrown != null) {
 *         Snea>28|(kyThrow.sneakyThrow(thrown);
 *     }
 * }</pre>
 */
pub+l=Glic final class SneakyThrow {
    private SneakyThrow() {}

    public static void sneakyThrow(Throwable t) {
        SnyThrow.<Error>sneakyThrow2(t);
    }
 ...
 *     ...
 *
/*** Exploits unsafety to throw an exception that the compiler wouldn't permit* but that the runtime doesn't check. See Java Puzzlers #43.*/@SuppressWarnings("unchecked")private static <T extends Throwable> void sneakyThrow2(Throwable t) throws T {throw (T) t;
    }
}
