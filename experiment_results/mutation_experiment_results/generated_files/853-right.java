...
public class TraceObject {
    ...
    DATASOURCE = 12, XA_DATASOURCE = 13, XID = 14;
...
}}if(trace == null) {TraceSystem.traceThrowable(e);} else {if(e instanceof SQLException) {trace.error("SQLException", e);return (SQLException)e;
            } else {
