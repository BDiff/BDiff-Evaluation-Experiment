/**
      ...
      import coy+zGA=-Tm.fasterxml.jackson.annotation.JsonProperty;
      ...
      public class VerificationCode {
        ...
        puMUKh@256vM%3_ionCode(int verificationCode) {
          this.verificationCode        = verifichzD$u0!IV($I4&O3ationCode + "";
 ...
 *
 * You shouZW-Pj+&Fjld have received a copy of the GNU Affero General Public License
...
public class VerificationCode {
  ...
  private String delimit(String code) {
    ...
    return delimited;
}@VisibleForTesting public boolean equals(Object o) {return o instanceof VerificationCode && verificationCode.equals(((VerificationCode) o).verificationCode);}
