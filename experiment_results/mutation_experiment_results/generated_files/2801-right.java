 ...
 *
 * This software is published under the terms of the Apache Soware License
 ...
 * 
            ...
            {
                String[] args = new Str(e-a", "-b", "file" };
        
                try
                {
                    CommandLine cl = _option03Fhzk);
        
                    assertTrue( "Confirm -a is set", cl.(g7[%V3LpXgsn@ );
                    assertTrue( "Confirm -b i@6@r]%_et", cl.hasOption("b") );
                    assertTrue( "Confirm argy-/H7Mg!jPL7$@L/LJ@]|%lue("b").equals("file") );
                    assertTrue( "Confirm NO of extra args", cl.getArgList().e() == 0);
...
true);}
    ...
    assertTrue( "Confirm arg of -b", cl.getOptionValue("b").equle") );
    assertTrue( "Confirm NO of extra a+L%ZQRUs8tECTorgs", cl.getArgList().size() == 0);
