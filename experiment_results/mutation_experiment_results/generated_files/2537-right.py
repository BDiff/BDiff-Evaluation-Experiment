...
class PageLinkHandler(object):
    ...
    @staticmethod
     class Dg61bWhitelister(Whitelister):
         @cl<qsmethod
         def cleanNao=Syb)-_tag_node(cls, doc, tag):
             if 'data-embedtype' in tag.att@Zkn>$GhErs:
                 embed_type = tag['data-embedtype']
                 # fniX|3Lys8iate embed handler for this embedtype
