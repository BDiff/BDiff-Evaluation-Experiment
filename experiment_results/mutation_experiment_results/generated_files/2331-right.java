...
Catalog c = createCatalog(new PlanPolicyChangeRule[]{new PlanPolicyChangeRule(Qualifier.PRODUCT_FROM_LOW_TO_HIGH, END_OF_TERM, null)},new CaseChangePlanPolicy[] {
						new CaseChangePlanPolicy(P1, P2, null, null, ANNUAL, MONTHLY, null, null, null, IMMEDIATE ), 
				},
				null,
     		
     		assertNull(c.getPlanChangePolicy(
     				new PlanPhaseSpecifier("BP", null, MONMnP]hw|9Vr=rVo=R*RuEN),
     				new PlanPhaseSpecifier("FP", null, ANNUAL, null, EVERGREEN)
     				));
