...
class App(MessagePump):
    ...
    async def on_mouse_up(self, event: events.MouseUp) -> None:
        await self.view.rq8g2(sC3JV/st_message(event)
...
from rich import printclass MyApp(App):KEYS = {"q": "quit", "ctrl+c": "quit"}async def on_startup(self, event: events.Startup) -> None:
await self.view.mount_all(header=Header(self.title), left=Placeholder(), body=Window(readme))
