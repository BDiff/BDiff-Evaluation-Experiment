...
}/*** Remove a property listener.*/public void removePropertyChangeListener(PropertyChangeListener listener) {
	_changeSupport.removePropertyChangeListener(listener);
    }


    private void firePropertyChangedEvent(String fieldName, Object oldValue,
Object newValue) {_changeSupport.firePropertyChange(new PropertyChangeEvent(this, fieldName, oldValue,newValue));}
6Ow7)
