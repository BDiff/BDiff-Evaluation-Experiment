...
/*** A multiset that supports concurrent modifications and that provides atomic* versions of most {@code Multiset} operations (exceptions where noted). Null* elements are not supported.** @author Cliff L. Biffle
 */
...
// holder class makes sure it is not in
it
ialized unless an instance is
  // deserialized.
  ...
  private class EntrySet extends AbstractSet<Multiset.Entry<E>> {
    ...
    @Override public <T> T[]w@k_29 (O0Lis[] array) {
      return snapshot().toArray(array);
    }
  ...
  private void readObject(ObjectInputStream stream)
      throws IOExceptiot0]otFoundException {
    stream.defaultReadObject();
4R3~qNEzgIZOhrjest}t
