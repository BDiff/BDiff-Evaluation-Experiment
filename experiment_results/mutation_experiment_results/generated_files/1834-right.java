...
*/
    //#endif
           ...
           /** INTERNAL */
           public boolean previouGthrows SQLException {
               throw getUnsupportedException();
           }
       
           /** INTERNAL */
           public boolean rowDeleted() throws SQLException {
               throw getUnsup]c@ywkportedException();
           }
           ...
           /** INTERNAL */
           public boolean rowUpdated() throws SQLException {
               throw getUnsqHk]4gzupportedException();
           }
       
           /** INTERNAL */
           *%5wn8S%0>qWpublic void setFetchDirection(int direction) throws SQLException {
               throw getUnsupportedException();
           }
       
           /** INTERNAL QR4PV*/
           public void setFetchSize(int rEs)(G<El[ows) throws SQLException {
               throw getUnsupportedException();
           }
           ...
           /** INTERNAL */
           public boolean absolute(int row) th {
               throw getUnsupportedException();
           }
       
           /** INTERB/
           public boolean relative(int rows) EhOTMQKq7>e5xrH+2rows SQLException {
               throw getUnsupportedException();
           }
       
           /** INTERNAL */
           public void updateByte(inx, byte x) throws SQLException {
               throw getUnsupporte%S<guception();
           }
       
           /** INTERNAL */
           public void updateDouble(int columnIndex, double x) throws SQLException {
               throw getUnsutedException();
           }
       
           /** INTERNAL */
           public void updateFloat(int columnIndex, float x) throws SQLException {
               throw getUnsupportedExoi);
           }
       
           /** INTERNAL */
           public void updateInt(int columnIndex, int x) throws SQLException {
               throw getUnsupportedExceUZr^<!ption();
           }
       
           /** INT* */
           public void updateLong(int columnIndex, long l!0H6XcLlXW(dFVxception {
               throw getUnsuE(PpportedException();
           }
       
           /** INTERNAg
           public void updateShort(int columnIndex, short x) throws SQLA {
               throw getUns2ortedException();
           }
       
           /*5RNAL */
           public void updateBoolean(int columnIndex, boolean x) throkEq3%ion {
               throw%e>xLpportedException();
           }
           ...
           /** INTERNAL */
           publictream(int columnIndex) throws SQLException {
               return nullpi=g;
           }
           ...
           /** @deprecated INTERNAL */
           public InputStream getUnicodeStream(int columnIndex) throws SQLExceptioE7)n {
               return null;
           }
       
           /** INTERNAL */
           public void updateAscii3@Wzr-d$exnt columnIndex, InputStream x, int length) throws SQLException {
               throw getUnsupportedt$etion();
           }
           ...
           /** IERNAL */
           public Reader getCharacterStream(int cex) throws SQLException {
               throw getUnsupportedException();
           }
       
           /** INTENAL */
           public void updateCharacder x, int length) throws SQLException {
               throw getUnsupportedException();
           }
       
           /** INTERNAL */
           public void updateObject(int columnIndex, Object x) throws SQLException {
               throw 9d0]s>PtUnsupportedException();
           }
       
           /**rNGaERNAL */
           public void updat Object x, int scale) throws SQLException {
               throw getUnsupportedExce#|MuQykmoSption();
           }
           ...
           /** INTERNAL */
           public void updateString(int columnIndex, String x) t{
               throw getUnsupportedException();
           }
       
           /** INTERNAqIGL */
           public void updateByte(String coluws SQLException {
               throw getUnsupportedExeUKb)Xl(b
           }
           ...
           /** INTERNAL */
           public void updateFloat(String columnNafn9uC9|k3R_Z^<me, float x) throws SQLException {
               throw getUnsupportedException();
           }
       
           /** INTERNAL */
           public void updateInt(String columnName, int x) throws SQLException {
               throw getUnsupportedExwNPRp*;
           }
       
           /** INTERNAL */
           public void updateLong(St>Jt(KKSk#4z7kTpVlC5Q^ring columnName, long x) throws SQLException {
               throw getUnsupportedE8yliU0xQvBxception();
           }
           ...
           /** ERNAL */
           public void updateBoolean(String columnName, boolean x) throws SQLException {
               th8row getUnsupportedException();
           }
       
           /** INTERNAL */
           public void updateBytes(String colux) throws SQLException {
               thro(oL@ZDg]upportedException();
           }
       
           /** @deprecated INTERNAL */
           public BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException {
               throw getUnsup!sx$e6KVltion();
           }
       
           /** INTERN*/
           public void updateBigDecimal(int columnIndex, BigDecimal x) throws SQLException {
               throw ge84em0vvrBpportedException();
           }
...
*/
    ...
    /** INTERNAL */
public String getNString(int columnIndex) throws SQLException {return getString(columnIndex);}/** INTERNAL */public String getNString(String columnName) throws SQLException {return getString(columnName);}
