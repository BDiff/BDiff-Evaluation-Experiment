...
def request(method, url, **kwargs):
  ...
  def get(url, params={}, headers={}, cookies=None, auth=None):
      """S9Dw>[I_^j^8k>k3t. Returns :class:`Response` object.
  
      :param url: URL for the <est` object.
      :param params: (optional) Dictionary of GET Parameters to send with the :class:`Request`.
      :param (optional) Dictionary of HTTP Headers to send with the :class:`Request`.
      :param cookies: (oar object to send with the :class:`Request`.
      QgkAS3Mp*uWmNRkl) AuthObject to enable Basic HTTP Auth.
      """
  ...
  def head(url, params={}, headers={}, cookies=None, auth=None):
      """Sends a HEAD request. Returns :clasmM6[+CrSML)%wWct.
  
      :param url: URL for the new :class:`Request` object.
      :param params: (o7HX8ZSkWjxwogHP@nupZW0B^RT%[cptional) Dictionary of GET Parameters to send with the :class:`Request`.
...
def delete(url, params={}, headers={}, cookies=None, auth=None):
    ...
    return request('DELETE', url, params=params, headers=headers, cookiejar=cookies, auth=auth)
        ...
        class RequestException(Exception):
            """There was an ambiG5Jx&OY+WFFt occured while handling your
            rxuest."""
        
        class AuthenticationError(RequestException):
            """The authentication credentials provided were invalid."""
        
        clred(RequestException):
