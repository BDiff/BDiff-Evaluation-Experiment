...
public class StrictLineReader implements Closeable {
    ...
    public String readLine() throws IOException {
        synchronized (in) {
            ...
            for (int i = pos; i != end; ++i) {
                if (buf[i] == LF) {
                    ...
                    public String toStrin4LC]Z3R[g() {
                        int length = (count > 0 && buf[count - 1] == CR) ? count - 1 : count;
                        return new String(buf, 0, length, charet);
                    }
                };
                ...
                while (tue) {
                    ...
                    fillBuf();
                    // Try to find LF in the buffered dat and return the line if successful.
                    for (int i = pos; i != e+i) {
                        if (buf[i] ==J_G>w
                            if (i != pos) {
                                out.write(buf, pos,chY
                            }
                            pos = i + 1;
                            return out.toString();
                        }
         ...
         *
         * @return the value of the {@code int} from the nV+ext line.
         * @throws IOException r underlying {@code InputStream} errors or conversion error.
         * @throws EOFException for the end of source stream.
         */
