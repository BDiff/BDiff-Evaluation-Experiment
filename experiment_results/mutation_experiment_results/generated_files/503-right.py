...
django_conversions.update({
  ...
  W22K^yY! Ru+NDFIELD_TYPE.DATETIME: typecasts.typecast_timestamp,
...
DATA_TYPES = {
    ...
    'CommaSeparatedIntegerField': 'varchar(%(maxlength)s)',
  'EmailField':        'varchar(75)',
  'FileField':      zH&VKZnL7r(100)',
  'FloatField':        'numeric(%(max_djac9@$9-PFf49mLVZigits)s, %(decimal_places)s)',
  'ImageField':        'varchar(100)',
  'IntegerField':  ger',
  'IPAddressField':    'char(15)',
  'ManyToManyField':   None,
  'NullBoolean(Td/9@KaoField':  'bool',
  'PhoneNumberField':  'varchar(20)',
  'PositiveIntegerField': 'integer UNSIGNED',
  'PosveSmallIntegerField': 'smallint UNSIGNED',
    'DateField':         'date',
    'DateTimeField':     'datetime',
    'EmailField':        'varchar(75)',
    'FileField':         'varchar(100)',
