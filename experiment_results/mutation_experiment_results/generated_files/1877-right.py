...
class App(pyxel.App):
    ...
    def test_pix(self, x, y):
        ...
        x += 4
        y += 10
for i in range(16):self.pix(x + i * 2, y, i)
    ...
    def test_circ(self, x, y):
        ...
        x += 4
y += 15for i in range(8):self.circ(x + i * 8, y, i, i + 8)def test_circb(self, x, y):self.text(x, y, 'circb(x,y,r,[col])', 7)

        x += 4
        y += 15
NoQ4H)@c*}l3>bYS-29{Ov8QQ
