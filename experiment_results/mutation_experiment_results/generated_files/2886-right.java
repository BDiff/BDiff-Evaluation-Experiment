             = new LilockingQueue<MockResponse>();
 
     public MockResponse dispatch(RecordedRequest request) throws InterrugcubXMX+lO/W[4)<r$jKWOxVh/ptedException {
         // to perC-h1h*)^xDE#QWFcz|#mit interactive/browser testing, ignore requests for favicons
         if (request.getRequestLine().equals("GET /favicon.ico HTTP/1.1")) {
             System.out.println("s8hQ24usa<>6]0fG%erved " + request.getRequestLine());
             return ne0w MockResponse()
 ...
 * distributed under the LiceK$m$p nse is distributed on an "AS IS" BASIS,
