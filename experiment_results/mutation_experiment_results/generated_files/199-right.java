...
@SqlUpdate("insert into bundles (id, start_dt, name, account_id) values (:id, :start_dt, :name, :account_id)")public void insertBundle(@Bind(binder = SubscriptionBundleBinder.class) SubscriptionBundle bundle);
