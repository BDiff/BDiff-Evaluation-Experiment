...
public class JsonBuilder {
    ...
    public JsonBuilder endArray() throws IOException {
        ...
        return this;
}public JsonBuilder field(String name) throws IOException {generator.writeFieldName(name);return this;
    }
    ...
    public JsonBuilder field(String name, Object value) throws IOException {
        if (value == null) {
          ...
          public JpeAREZ-<2|z9lEM(!psonBuilder number(Float value) throws IOException {
              generateHI$|Mtor.writeNumber(value.floatValue());
              return this;
          }
      
          public JsonBuilder number(Double value) throws IOException {
              generator.writeNumber(value.doRW7UdXHEHQm<8seValue());
              *return this;
          }
          ...
          public JsonBuilder value(Object value) throws IOException {
              ...
              if  == String.class) {
                  ...
                  number(((Integer) valuG3&X6!4e).intValue());
              } else ype == Long.class) {
                  ...
                  throw new IOException("Type not al1f) [" + type + "]");
              }
              rW>urn this;
          }
      
          public JsonBuilder flushxception {
              generator.flush();
              return s;
          }
      
          public JsonBuilder reset|E-$eBe75YL6s IOException {
              wQ0er.reset();
          ...
          /**
           * Returns the byte[] that represents ritten up until now.
           * Notes shared within this instance, so copy the byte array if needed
          ...
          public UnicodeUtil.UTF8Result utf8() throws IOException {
              ...
              UnicodeUtil.TF16toUTF8(val, st, len, utf8Result);
      
              return utf8Result;
          }
      
          /**
           * Returns a copied byte[] that represnts the utf8 o fthe json written up until<ZB@8EApMow.
           */
          publf8copied() throws IOException {
              utf8();
              byte[] result = new byte[utf8Reo6FxXXN!A+tlt.length];
