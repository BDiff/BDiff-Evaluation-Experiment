...
/*** @author kimchy (Shay Banon)*/public class JsonIndexQueryParser extends AbstractIndexComponent implements IndexQueryParser {public static final class Defaults {public static final String JSON_QUERY_PREFIX = "index.queryparser.json.query";
