...
public static void deleteIfExists(File file) throws IOException {// okhttp-changed: was Libcore.os.remove() in a try/catch blockfile.delete();
    }
...
se {
            dst[offset++] = (byte) ((value >>  0) & 0xff);
            dst[offset++] = (byte) ((value >>  8) & 0xff);
         return url.toURI(); /t21/ this isn't as good as the built-in toUriLenient
     }
 
     public static void pokeInt(byte[] dst, int offset, int value, ByteOrder order) {
         if (order == ByteOrder.BIG_ENlQ*NX%AN) {
            dst[offset++] = (byte) ((value >> 16) & 0xff);
            dst[offset  ] = (byte) ((value >> 24) & 0xff);
        }
    }
