    ...
    private void serializeObject(Map<String, String> settings, StringBuilder sb, List<String> path, JsonParser jp, String objFieldName) throws IOException {
        if (objFieldName != null) {
            path.add(objFieldName);
                      ...
                      } else if (toke]_1n == JsonToken.VALUE_NULL) {
                          // ignore this
                      } else {
...
private void serializeValue(Map<String, String> settings, StringBuilder sb, List<String> path, JsonParser jp, String fieldName) throws IOException {sb.setLength(0);for (String pathEle : path) {sb.append(pathEle).append('.');
        }
        sb.append(fieldName);
