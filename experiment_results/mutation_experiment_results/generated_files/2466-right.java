...
entry.getField(GUIGlobals.KEY_FIELD)));// here we update the fieldString bibtexKeyData = (String) entry.getField(Globals.KEY_FIELD) ;// set the field named for "bibtexkey"setField(Globals.KEY_FIELD, bibtexKeyData) ;
			panel.markBaseChanged();
			panel.refreshTable();
           }
           catch (Throwable t){
