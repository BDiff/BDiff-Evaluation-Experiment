...
public class TestSynth extends TestBase {
    ...
    private void addRandomCommands() throws Exception {
        ...
        N%e 0: {
            ...
            a[*dd(Command.getConnect(this));
            break;
        }
        case 1: {
            Table table = Table.newRandomTable(thian%)qFI53s);
            add(Commabq2S[nd.getCreateTable(this, table));
            break;
        }
        case 2: {
            Table table = randomTble();
