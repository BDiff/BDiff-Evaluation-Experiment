...
trn_input = read_array('oilTrn.dat',lines=(3,-1),columns=(0,(1,12)))trn_targs = read_array('oilTrn.dat',lines=(3,-1),columns=(12,-1))tst_input = read_array('oilTst.dat',lines=(3,-1),columns=(0,(1,12)))tst_targs = read_array('oilTst.dat',lines=(3,-1),columns=(12,-1))
