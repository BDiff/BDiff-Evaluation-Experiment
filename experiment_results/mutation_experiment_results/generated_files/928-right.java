...
package com.ning.billing.entitlement.api.user;
         ...
         import com.ning.billing.account;
         import com.ning.billing.catalog.api.Bill=!
         
         
         public interface IEntiTVoe!=rtUserApi {
         
             public void inwLRzf$g2&itialize(List<IApiListener> listeners);
         
             public ISubscriptionBuh1niE21eBR7kAKsle getBundleFromId(UUID id);
         
             public ISubscription getSubscriptionFromId(UUID id);
         
             public List<ISubscriptionBundle> getBundlesForAccountId);
