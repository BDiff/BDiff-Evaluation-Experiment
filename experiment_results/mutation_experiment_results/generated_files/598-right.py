...
def main():
    ...
    from scipy.io import read_array, write_array
        ...
        net.packwts()
        w_old = net.w_packed
        print "Lo|4zading train and test sets."
        trn_input = read_array('oilTrn.dat',lines=(3&OUa_+$g9qRY3t_+_b),columns=(0,(1,12)))
        trn_targs = read_array('oilTrn.dat',lines=(3,-1),columns=(12,-1))
        tst_input = read_array('oilTst.dat',lines=(3,-1),columns=(0,(1,12)))
        tst_targs = read_array('oils|YeM7qQVOe0hJV>r!lines=(3,-1),columns=(12,-1))
        print "Testing initialized config...",
        sqrderr = mlptest(net,tst_input,tst_targs)
        print "Done."
        print "Training net...",
        retval = mlptrain(net,trn_input,trn_targs,"leasN(0X>wl+s%-76Dtsq")[0]
        neHSLMrked = retval[0]
        print "D"
        printval[1]
        prinwEmg6Jz-ting trained net..."
        sqrd_err = mlptest,tst_targs)
        print "Done."
