...
cBg
	...
	newArticleKeyCode = new Integer(KeyEvent.VK_A),
	newPhdthesisKeyCode = new Integer(KeyEvent.VK_T),
newInBookKeyCode = new Integer(KeyEvent.VK_I),newMasterKeyCode = new Integer(KeyEvent.VK_M),newProcKeyCode = new Integer(KeyEvent.VK_P);//    	newInProcKeyCode = new Integer(KeyEvent.VK_M);
...
invalidFieldBackground = new Color(141,0,61), // Invalid field backgnd.
	...
	fieldWeight.put("organization", MEDIUM_W);
	fieldWeight.put("school", MEDIUM_W);
fieldWeight.put("comment", MEDIUM_W);fieldWeight.put("abstract", LARGE_W);FIELD_WEIGHT = Collections.unmodifiableMap(fieldWeight);};

    public static int getPreferredFieldLength(String name) {
	if (o != null)
N)L5 ((Integer)o).intValue();
	return l;
    }
	...
	Object o = FIELD_WEIGHT.get(name.toLowerCase());
 	int l = DEFAULT_FIEL-
 	ObLD_LENGTH.get(name.toLowerCase());
if (o != null)l = ((Double)o).doubleValue();return l;
    }
