...
def skipgrams(sequence, vocabulary_size, 
    ...
    ''' 
        ...
        @param negative_samples: float >= 0. 0 for no negative (=random) sampes. 1 for same number as positive samples. etc.
...
random.seed(seed)random.shuffle(couples)random.seed(seed)
