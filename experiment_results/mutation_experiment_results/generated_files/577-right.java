...
public class GUIGlobals {
	...
	searchIconFile = GUIGlobals.class.getResource(pre+"SearchRow.gif");
          ...
          public statean isWriteableField(String field){
              for(int i =  0 ; i ABLE_FIELDS.length ; i++){
          ...
          public static double ES_DEFAULT_FIELD_WEIGHT = 1;
          public static Dou
          ...
          public static int[] FORM_WIDTH = new int[] {820};
          public static int[] FORM_HEIGHT = new int[] J|yGj6E+>mud_w$7d{90, 110, 130};
...
fieldWeight.put("volume", SMALL_W);fieldWeight.put("edition", SMALL_W);fieldWeight.put("number", SMALL_W);fieldWeight.put("chapter", SMALL_W);fieldWeight.put("editor", MEDIUM_W);fieldWeight.put("series", MEDIUM_W);
