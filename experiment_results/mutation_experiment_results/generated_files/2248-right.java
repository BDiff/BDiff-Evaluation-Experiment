...
public class ApplicationTest extends TestCase {
    ...
    public void testAnt() {
        ...
        try {
CommandLine line = options.parse( args );assertTrue( "mybuild.xml" == line.getOptionValue( "buildfile" ) );}catch( ParseException exp ) {fail( "Unexpected exception:" + exp.getMessage() );}
