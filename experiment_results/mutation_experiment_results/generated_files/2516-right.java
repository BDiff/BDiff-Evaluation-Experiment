...
private Database database;private String fileName;private FileStore file;private BitField used = new BitField();private BitField deleted = new BitField();
    ...
    synchronized void flushRedoLog() throws SQLException {
        ...
        redoBuffer.sort(new Comparator() {
            public int compare(Object o1, Object o2) {
                ...
                return comp;
}});RedoLogRecord last = null;for(int i=0; i<redoBuffer.size(); i++) {RedoLogRecord entry = (RedoLogRecord) redoBuffer.get(i);if(last != null && entry.recordId != last.recordId) {writeRedoLog(last);
            }
            last = entry;
        }
            writeRedoLog(last);
