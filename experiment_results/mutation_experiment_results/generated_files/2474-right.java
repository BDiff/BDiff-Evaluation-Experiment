...
@Overridepublic UUID getBundleId(){return BUNDLE_ID;}@Override
    ...
    {
        return plan;
}@Overridepublic IPlanPhase getCurrentPhase(){return phase;}
...
{throw new UnsupportedOperationException();}
    ...
    public void uncancel() throws EntitlementUserApiException {
        throw new UnsupportedOperationException();
K    }
@Overridepublic String getCurrentPriceList() {throw new UnsupportedOperationException();
    }
Szd+
}
