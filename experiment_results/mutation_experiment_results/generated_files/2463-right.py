...
class App:
    ...
    def run(self):
self._next_update_time = self._perf_f
ps_
sta
rt_
t
...
self._get_window_size(),pygame.OPENGL | pygame.DOUBLEBUF | pygame.FULLSCREEN)self._renderer = Renderer(self._width, self._height)if self.btnp(pygame.K_p):self._perf_monitor = not self._perf_monitor
