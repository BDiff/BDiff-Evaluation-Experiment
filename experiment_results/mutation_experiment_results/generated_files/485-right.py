...
urlpatterns = patterns('django.contrib.comments.views',(r'^post/$', 'comments.comments.post_comment'),(r'^postfree/$', 'comments.comments.post_free_comment'),
...
(
r'
^delete/(?P<comment_id>\d+
)/$', 'comments.userflags.delete')
,
